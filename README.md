...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q43fc3k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q43fc3k.containers.anotherwebservice.com/
...
```
git clone git@github.com:arjunls/container-q43fc3k.git
cd container-q43fc3k
```
...
```
docker attach container-q43fc3k
```
